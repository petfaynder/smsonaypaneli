...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : 'Kayıt olurken bir hata oluştu')
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-blue-100">
          Veya{' '}
          <Link href="/auth/login" className="font-medium text-white hover:text-blue-200 transition-colors">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-white">
                <span>
                  <Link href="/terms" className="font-medium text-blue-200 hover:text-white transition-colors">
                    Kullanım Koşulları
                  </Link>
                  {' '}ve{' '}
                  <Link href="/privacy" className="font-medium text-blue-200 hover:text-white transition-colors">
                    Gizlilik Politikası
                  </Link>
                  'nı kabul ediyorum
                </span>
